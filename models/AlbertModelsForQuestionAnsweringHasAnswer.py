"""AlbertForQuestionAnsweringHasAnswerUsePredictions model. """
...
@add_start_docstrings(
    """
    ALBERT Model with a span classification head on top for extractive question-answering (a linear layers on top of 
...
class AlbertForQuestionAnsweringHasAnswerUsePredictions(AlbertPreTrainedModel):
